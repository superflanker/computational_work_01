...
\author{
	...
	\IEEEauthorblockA{\IEEEauthorrefmark{2}caiomizerkowski@gmail.com}
	\IEEEauthorblockA{\IEEEauthorrefmark{3}christian0294@yahoo.com.br}
	\IEEEauthorblockA{\IEEEauthorrefmark{4}eduardo.reis02@gmail.com}
}
...
\begin{abstract}
In this paper, four optimization algorithms belonging to Quasi-Newton Class are implemented, tested and discussed. 
