...
\end{figure}
The isolines for Ackley Function shows that there are at least 4 pitfalls near the optimal solution, so, the search space needs to be reduced to $[-0.05, 0.05]$ to avoid wrong convergence. All the algorithms converges quite smoothly following a straight line
